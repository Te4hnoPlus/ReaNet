/**
 * @fileoverview USED ONLY FOR COMPILATION | Google Clouse Compiler 
 * @suppress {deprecated}
 * @provideGoog
 */
 ...
 * @param {string} name 
 * @param {*=} object 
 * @param {boolean=} overwriteImplicit
 * @param {?Object=} objectToExportTo
 * @private
 */
...
/**
 * {@link goog.html.SafeHtmlFormatter}
 *
 * @param {string} str
 * @param {!Object<string, string>=} opt_values
 * @param {!goog.GetMsgOptions=} opt_options
 * @return {string}
 */
